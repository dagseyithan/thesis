...
class MLPLSTM(Layer):
    ...
    def build(self, input_shape):
        ...
        self.dense_1 = Dense(6000, activation='tanh', kernel_initializer='glorot_uniform', use_bias=True)
        self.dense_2 = Dense(600, activation='tanh', kernel_initializer='glorot_uniform', use_bias=True)
        self.dense_3 = Dense(60, activation='tanh', kernel_initializer='glorot_uniform', use_bias=True)
        self.dense_4 = Dense(6, activation='tanh', kernel_initializer='glorot_uniform', use_bias=True)
        self.dense_5 = Dense(1, activation='tanh', kernel_initializer='glorot_uniform', use_bias=True)
...
class MLPScore(Layer):
    ...
    def build(self, input_shape):
        ...
        self.dense_1 = Dense(3600, activation='tanh', kernel_initializer='glorot_uniform', use_bias=True)
        self.dense_2 = Dense(360, activation='tanh', kernel_initializer='glorot_uniform', use_bias=True)
        self.dense_3 = Dense(36, activation='tanh', kernel_initializer='glorot_uniform', use_bias=True)
        self.dense_4 = Dense(1, activation='sigmoid', kernel_initializer='glorot_uniform', use_bias=True)
...
def SemanticSimilarityNetwork():
    ...
    conv1D_2n = Conv1D(filters=40, kernel_size=2, kernel_initializer='glorot_uniform',
                       ...
                       use_bias=True, activation='tanh', padding='same', name='conv1D_2n')
    conv1D_3n = Conv1D(filters=40, kernel_size=3, kernel_initializer='glorot_uniform',
                       bias_initializer='glorot_uniform',input_shape=(MAX_TEXT_WORD_LENGTH, EMBEDDING_LENGTH),
                       use_bias=True, activation='tanh',padding='same', name='conv1D_3n')
    ...
    conv2D_3x3 = Conv2D(filters=40, kernel_size=(3,3), kernel_initializer='glorot_uniform',
                        bias_initializer='glorot_uniform', input_shape=(MAX_TEXT_WORD_LENGTH, EMBEDDING_LENGTH),
                        use_bias=True, activation='tanh', padding='same', name='conv2D_3x3')
...
test_size = 100
epochs = 50
model_name = model_head + '/' + configurations.EMBEDDER+str(EMBEDDING_LENGTH) + '_bsize=' + str(BATCH_SIZE) +'_ep=' + str(epochs)+  '_act=' + selected_activation + '_slen=' + str(configurations.MAX_TEXT_WORD_LENGTH) \
